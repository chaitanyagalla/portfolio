...
export default function Tooltip({
  ...
  return (
    <span className="group/tip relative inline-flex" tabIndex={0}>
      ...
      <span
        role="tooltip"
        className="pointer-events-none absolute bottom-full left-1/2 z-50 mb-2 w-max max-w-[240px] -translate-x-1/2 translate-y-1 border border-line bg-well px-3 py-1.5 font-mono text-[11px] leading-snug text-mist opacity-0 shadow-lg transition-all duration-200 group-hover/tip:translate-y-0 group-hover/tip:opacity-100 group-focus-within/tip:translate-y-0 group-focus-within/tip:opacity-100"
      >
        {tip}
